    ...
    public static class Convert {
        ...
        public static AdminApplicationDTO toAdminAppDTO(AdminApplication application) {
            ...
            return AdminApplicationDTO.builder()
                    ...
                    .username(application.getUser() != null ? application.getUser().getUsername() : null)
                    .email(application.getUser() != null ? application.getUser().getEmail() : null)
                    .processorUsername(application.getProcessor() != null ? application.getProcessor().getUsername() : null)
                    .build();
        }
    }
