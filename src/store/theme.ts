  ...
  actions: {
    ...
    applyTheme() {
      ...
      // 明亮模式配置
        ...
        root.style.setProperty('--bg-color', '#f0f2f5')                     // 背景色
        root.style.setProperty('--text-color', '#303133')                   // 文本色
        root.style.setProperty('--border-color', '#dcdfe6')                 // 边框色
        root.style.setProperty('--header-bg-color', '#2c3e50')              // 头部背景
        root.style.setProperty('--sidebar-bg-color', '#304156')             // 侧边栏背景
        root.style.setProperty('--sidebar-text-color', '#bfcbd9')           // 侧边栏文本
